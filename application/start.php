...
Autoloader::map(array(
	'Base_Controller' => path('app').'core/base.php',
));
...
|--------------------------------------------------------------------------
|
| Bootstrap for application, to extend, debug, composer, inject application
| resources, and do anything else.
|
*/

require path('app').'bootstrap/start.php';